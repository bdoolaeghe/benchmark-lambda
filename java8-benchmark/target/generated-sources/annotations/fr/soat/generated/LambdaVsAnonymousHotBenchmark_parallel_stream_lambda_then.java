...
public final class LambdaVsAnonymousHotBenchmark_parallel_stream_lambda_then {
    ...
    public Collection<ThroughputResult> parallel_stream_lambda_then_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_lambdavsanonymoushotbenchmark0_0.parallel_stream_lambda_then(l_personnescontainer2_G, l_blackhole1_2);
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            parallel_stream_lambda_then_thrpt_jmhStub(control, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymoushotbenchmark0_0, l_blackhole1_1);
            ...
            results.add(new ThroughputResult(ResultRole.PRIMARY, "parallel_stream_lambda_then", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void parallel_stream_lambda_then_thrpt_jmhStub(InfraControl control, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> parallel_stream_lambda_then_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0 = _jmh_tryInit_f_lambdavsanonymoushotbenchmark0_0(control, threadParams);
            Blackhole_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            parallel_stream_lambda_then_avgt_jmhStub(control, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymoushotbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "parallel_stream_lambda_then", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void parallel_stream_lambda_then_avgt_jmhStub(InfraControl control, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> parallel_stream_lambda_then_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0 = _jmh_tryInit_f_lambdavsanonymoushotbenchmark0_0(control, threadParams);
            Blackhole_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            parallel_stream_lambda_then_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymoushotbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_lambdavsanonymoushotbenchmark0_0.parallel_stream_lambda_then(l_personnescontainer2_G, l_blackhole1_2);
    ...
    public Collection<SingleShotResult> parallel_stream_lambda_then_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0 = _jmh_tryInit_f_lambdavsanonymoushotbenchmark0_0(control, threadParams);
            Blackhole_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            parallel_stream_lambda_then_ss_jmhStub(control, batchSize, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymoushotbenchmark0_0, l_blackhole1_1);
            control.preTearDown();
            while(!PersonnesContainer_jmh.tearIterationMutexUpdater.compareAndSet(l_personnescontainer2_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "parallel_stream_lambda_then", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void parallel_stream_lambda_then_ss_jmhStub(InfraControl control, int batchSize, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
