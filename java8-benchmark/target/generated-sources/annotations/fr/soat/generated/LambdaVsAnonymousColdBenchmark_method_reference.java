...
public final class LambdaVsAnonymousColdBenchmark_method_reference {
    ...
    public Collection<ThroughputResult> method_reference_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            while (control.warmupShouldWait) {
                l_lambdavsanonymouscoldbenchmark0_0.method_reference(l_personnescontainer2_G, l_blackhole1_2);
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            method_reference_thrpt_jmhStub(control, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymouscoldbenchmark0_0, l_blackhole1_1);
    ...
    public void method_reference_thrpt_jmhStub(InfraControl control, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousColdBenchmark_jmh l_lambdavsanonymouscoldbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> method_reference_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            method_reference_avgt_jmhStub(control, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymouscoldbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public void method_reference_avgt_jmhStub(InfraControl control, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousColdBenchmark_jmh l_lambdavsanonymouscoldbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> method_reference_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            method_reference_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymouscoldbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_lambdavsanonymouscoldbenchmark0_0.method_reference(l_personnescontainer2_G, l_blackhole1_2);
    ...
    public Collection<SingleShotResult> method_reference_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            method_reference_ss_jmhStub(control, batchSize, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymouscoldbenchmark0_0, l_blackhole1_1);
            control.preTearDown();
            while(!PersonnesContainer_jmh.tearIterationMutexUpdater.compareAndSet(l_personnescontainer2_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
    ...
    public void method_reference_ss_jmhStub(InfraControl control, int batchSize, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousColdBenchmark_jmh l_lambdavsanonymouscoldbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
