...
import org.openjdk.jmh.infra.generated.Blackhole_jmh;
import fr.soat.generated.LambdaVsAnonymousHotBenchmark_jmh;
import fr.soat.generated.PersonnesContainer_jmh;
@Generated("org.openjdk.jmh.generators.core.BenchmarkGenerator")
public final class LambdaVsAnonymousHotBenchmark_parallel_stream_anonymous_class {
    ...
    public Collection<ThroughputResult> parallel_stream_anonymous_class_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0 = _jmh_tryInit_f_lambdavsanonymoushotbenchmark0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_lambdavsanonymoushotbenchmark0_0.parallel_stream_anonymous_class(l_personnescontainer2_G, l_blackhole1_2);
            }

            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            parallel_stream_anonymous_class_thrpt_jmhStub(control, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymoushotbenchmark0_0, l_blackhole1_1);
            ...
            if (control.isLastIteration()) {
                ...
                f_blackhole1_2 = null;
                f_lambdavsanonymoushotbenchmark0_0 = null;
                f_blackhole1_1 = null;
            }
            Collection<ThroughputResult> results = new ArrayList<ThroughputResult>();
            results.add(new ThroughputResult(ResultRole.PRIMARY, "parallel_stream_anonymous_class", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void parallel_stream_anonymous_class_thrpt_jmhStub(InfraControl control, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public Collection<AverageTimeResult> parallel_stream_anonymous_class_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0 = _jmh_tryInit_f_lambdavsanonymoushotbenchmark0_0(control, threadParams);
            Blackhole_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            parallel_stream_anonymous_class_avgt_jmhStub(control, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymoushotbenchmark0_0, l_blackhole1_1);
            res.operations /= control.iterationParams.getBatchSize();
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
            ...
            results.add(new AverageTimeResult(ResultRole.PRIMARY, "parallel_stream_anonymous_class", res.getOperations(), res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void parallel_stream_anonymous_class_avgt_jmhStub(InfraControl control, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public Collection<SampleTimeResult> parallel_stream_anonymous_class_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0 = _jmh_tryInit_f_lambdavsanonymoushotbenchmark0_0(control, threadParams);
            Blackhole_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            parallel_stream_anonymous_class_sample_jmhStub(control, buffer, targetSamples, control.benchmarkParams.getOpsPerInvocation(), batchSize, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymoushotbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_lambdavsanonymoushotbenchmark0_0.parallel_stream_anonymous_class(l_personnescontainer2_G, l_blackhole1_2);
            ...
            results.add(new SampleTimeResult(ResultRole.PRIMARY, "parallel_stream_anonymous_class", buffer, control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void parallel_stream_anonymous_class_sample_jmhStub(InfraControl control, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
    ...
    public Collection<SingleShotResult> parallel_stream_anonymous_class_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            Blackhole_jmh l_blackhole1_1 = _jmh_tryInit_f_blackhole1_1(control, threadParams);
            LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0 = _jmh_tryInit_f_lambdavsanonymoushotbenchmark0_0(control, threadParams);
            Blackhole_jmh l_blackhole1_2 = _jmh_tryInit_f_blackhole1_2(control, threadParams);
            ...
            RawResults res = new RawResults(control.benchmarkParams.getOpsPerInvocation());
            int batchSize = control.iterationParams.getBatchSize();
            parallel_stream_anonymous_class_ss_jmhStub(control, batchSize, res, l_personnescontainer2_G, l_blackhole1_2, l_lambdavsanonymoushotbenchmark0_0, l_blackhole1_1);
            control.preTearDown();
            while(!PersonnesContainer_jmh.tearIterationMutexUpdater.compareAndSet(l_personnescontainer2_G, 0, 1)) {
                if (Thread.interrupted()) throw new InterruptedException();
            }
            ...
            results.add(new SingleShotResult(ResultRole.PRIMARY, "parallel_stream_anonymous_class", res.getTime(), control.benchmarkParams.getTimeUnit()));
            return results;
        } else
            throw new IllegalStateException("Harness failed to distribute threads among groups properly");
    }

    public void parallel_stream_anonymous_class_ss_jmhStub(InfraControl control, int batchSize, RawResults result, PersonnesContainer_jmh l_personnescontainer2_G, Blackhole_jmh l_blackhole1_2, LambdaVsAnonymousHotBenchmark_jmh l_lambdavsanonymoushotbenchmark0_0, Blackhole_jmh l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    LambdaVsAnonymousHotBenchmark_jmh f_lambdavsanonymoushotbenchmark0_0;
    
    LambdaVsAnonymousHotBenchmark_jmh _jmh_tryInit_f_lambdavsanonymoushotbenchmark0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        LambdaVsAnonymousHotBenchmark_jmh val = f_lambdavsanonymoushotbenchmark0_0;
        if (val == null) {
            val = new LambdaVsAnonymousHotBenchmark_jmh();
            f_lambdavsanonymoushotbenchmark0_0 = val;
        }
        return val;
    }
